...
export const NFT_SALE_ABI = [
  ...
  {
    inputs: [{ name: "nftType", type: "uint8" }],
    name: "getNFTPrice",
    outputs: [{ name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
...
// NFT Miner Contract ABI
export const NFT_MINER_ABI = [
  {
    inputs: [{ name: "owner", type: "address" }],
    name: "getUserNFTs",
    outputs: [
